## Designing Pizza, using python langugage. 

# Here we are taking "turtle" module -drawing board.
...
screen.title("This PIZZA DESIGNED via PYTHON programming LANGUAGE")
...
for x in range(0, 20):
    my_turtle.pendown()
    my_turtle.left(45)  # 45 degree means here
