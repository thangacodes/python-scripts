...
def FuncSendText():
    UserInput = InputText.get("1.0", END).strip().lower()
    DisplayText.config(state=NORMAL)
    DisplayText.insert(END, "Bot: Welcome to Corp Quick Help ChatBot. How can I help you?\n")
    DisplayText.insert(END, "You: " + UserInput + "\n")
    ...
    # Keyword-specific responses
        ...
        DisplayText.insert(END, "Bot: Please try rebooting in safe mode. If that fails, connect to IT for OS recovery.\n")
