...
def available_fruits():
    stock = ["apple", "banana", "grape", "blackberry", "blueberry", "pineapple", "strawberry", "cherry", "watermelon",
             "orange"]
...
def script_begin():
    ...
    if userinput in fruits:
        ...
        print(
            f"[bold red] Sorry, {userinput} is not available in our shop. Please choose from the available fruits listed above [/bold red]")
